...
namespace Photon
{
    public enum PhotonErrors
    {
        ...
        // that way or a failure in initializing a pthread_mutex (or
        // on Windows, a critical section).
        NOT_ENOUGH_RESOURCES = 4,

        // The provided handle is of the wrong type (C API). This could
        // happen if you provide a queue handle to access a hash map
        // or something similar. It can also occur if you try to
        // access an object after closing it.
        //
        // If you are seeing this error for the C++ API (or some other
        // object-oriented interface), you've just found an internal
        // error... (the handle is encapsulated and cannot be
        // modified using the public interface).
        WRONG_TYPE_HANDLE = 5,
        ...
        // each working with its own copy would have been be
        // possible but was deemed unnecessary.
        ...
        // ([a-zA-Z0-9]) and the underscore ('_'). The first
        // character of the name must be letter.
        ...
        // (in the namespace
        // "http://www.w3.org/2001/XMLSchema-instance") to point to
        ...
        // likely reason is that the schema file is not at the
        // location indicated by the attribute schemaLocation of
        ...
        // is an error in the schema. To debug this you can use
        ...
        // reference counting is wrong (errno = EBUSY). Please
        // contact us.
