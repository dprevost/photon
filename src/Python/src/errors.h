...
PyObject * AddErrors(void)
{
    ...
    key = PyString_FromString("DATA_DEF_UNSUPPORTED");
    if ( key == NULL ) {
        Py_DECREF(value);
        PyDict_Clear(errors);
        Py_DECREF(errors);
    ...
    key = PyString_FromString("SYSTEM_OBJECT");
    if ( key == NULL ) {
        Py_DECREF(value);
        PyDict_Clear(errors);
        Py_DECREF(errors);
    ...
    key = PyString_FromString("INVALID_DEF_OPERATION");
    if ( key == NULL ) {
        Py_DECREF(value);
        PyDict_Clear(errors);
        Py_DECREF(errors);
    ...
    key = PyString_FromString("INVALID_DATA_DEFINITION_TYPE");
    if ( key == NULL ) {
        Py_DECREF(value);
        PyDict_Clear(errors);
        Py_DECREF(errors);
