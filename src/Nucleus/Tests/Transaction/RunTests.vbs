...
ok_programs(1) = "CommitPass"
ok_programs(2) = "FiniPass"
ok_programs(3) = "InitPass"
ok_programs(4) = "RemoveLastPass"
ok_programs(5) = "RollbackPass"
ok_programs(6) = "TestFolder"
ok_programs(7) = "TestHashMap"
ok_programs(8) = "TestQueue"

fail_programs(0)  = "AddInvalidSig"
fail_programs(1)  = "AddNullChildOffset"
fail_programs(2)  = "AddNullContext"
fail_programs(3)  = "AddNullParentOffset"
fail_programs(4)  = "AddNullTx"
fail_programs(5)  = "CommitInvalidSig"
fail_programs(6)  = "CommitNullContext"
fail_programs(7)  = "CommitNullTx"
fail_programs(8)  = "FiniInvalidSig"
fail_programs(9)  = "FiniNullContext"
fail_programs(10) = "FiniNullTx"
fail_programs(11) = "InitNullContext"
fail_programs(12) = "InitNullTx"
fail_programs(13) = "InitZeroBlocks"
fail_programs(14) = "RemoveLastInvalidSig"
fail_programs(15) = "RemoveLastNullContext"
fail_programs(16) = "RemoveLastNullTx"
fail_programs(17) = "RollbackInvalidSig"
fail_programs(18) = "RollbackNullContext"
fail_programs(19) = "RollbackNullTx"

numTests = 29                 ' Sum of length of both arrays 
numFailed = 0
