...
void test_null_context( void ** state )
{
   ...
   expect_assert_failure( psonCursorGetFirst( pCursor, &pItem, NULL ) );
#endif
   return;
}
...
{
#if defined(PSO_UNIT_TESTS)
   expect_assert_failure( psonCursorGetFirst( NULL, &pItem, &context ) );
#endif
   return;
}
...
{
#if defined(PSO_UNIT_TESTS)
   expect_assert_failure( psonCursorGetFirst( pCursor, NULL, &context ) );
#endif
   return;
}
