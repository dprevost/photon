...
ok_programs.append('LogPass')
ok_programs.append('LogFileTest')

fail_programs.append('CloseNoInit')
fail_programs.append('CloseNULLLog')
fail_programs.append('CloseNULLError')
fail_programs.append('InitNULLDir')
fail_programs.append('InitNULLError')
fail_programs.append('InitNULLLog')
fail_programs.append('InitNULLSession')
fail_programs.append('LogNoInit')
fail_programs.append('LogNULLError')
fail_programs.append('LogNULLLog')
