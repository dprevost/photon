...
ok_programs(2) = "LogPass"
ok_programs(3) = "LogFileTest"

fail_programs(0) = "CloseNoInit"
fail_programs(1) = "CloseNULLLog"
fail_programs(2) = "CloseNULLError"
fail_programs(3) = "InitNULLDir"
fail_programs(4) = "InitNULLError"
fail_programs(5) = "InitNULLLog"
fail_programs(6) = "InitNULLSession"
fail_programs(7) = "LogNoInit"
fail_programs(8) = "LogNULLError"
fail_programs(9) = "LogNULLLog"

numTests = 14                 ' Sum of length of both arrays 
numFailed = 0
