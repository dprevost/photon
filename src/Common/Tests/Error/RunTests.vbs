...
ok_programs(0) = "AddHandlerPass"
ok_programs(1) = "AnyErrorPass"
ok_programs(2) = "ChainErrorPass"
ok_programs(3) = "FiniPass"
ok_programs(4) = "GetLastPass"
ok_programs(5) = "GetLengthPass"
ok_programs(6) = "InitPass"
ok_programs(7) = "Tests"

fail_programs(0)  = "AddHandlerNullDef"
fail_programs(1)  = "AddHandlerNullHandler"
fail_programs(2)  = "AddHandlerNullName"
fail_programs(3)  = "AnyErrorNullError"
fail_programs(4)  = "ChainErrorNullDef"
fail_programs(5)  = "ChainErrorNullHandler"
fail_programs(6)  = "ChainErrorInvalidSig"
fail_programs(7)  = "ChainErrorNoSetError"
fail_programs(8)  = "ChainErrorTooMany"
fail_programs(9)  = "FiniInvalidSig"
fail_programs(10) = "FiniNullError"
fail_programs(11) = "GetErrorInvalidSig"
fail_programs(12) = "GetErrorNullError"
fail_programs(13) = "GetErrorNullMsg"
fail_programs(14) = "GetErrorZeroLength"
fail_programs(15) = "GetLastNullError"
fail_programs(16) = "GetLengthNullError"
fail_programs(17) = "InitNoInitDefs"
fail_programs(18) = "InitNullError"
fail_programs(19) = "SetErrorInvalidSig"
fail_programs(20) = "SetErrorInvalidValue"
fail_programs(21) = "SetErrorNullError"
