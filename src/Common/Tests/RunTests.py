...
mem_fail_programs.append('CloseNullError')
mem_fail_programs.append('CloseInvalidSig')
mem_fail_programs.append('CloseMemNull')
mem_fail_programs.append('CreateBackNullError')
...
mem_fail_programs.append('OpenNullError')
...
mem_fail_programs.append('ReadOnlyNullError')
...
mem_fail_programs.append('ReadWriteNullError')
...
mem_fail_programs.append('SynchNullError')
