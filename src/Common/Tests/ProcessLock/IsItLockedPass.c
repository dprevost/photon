...
int main( int argc, char* argv[] )
{
   ...
   {
      fprintf( stderr, " vdscIsItLocked invalid answer before Acquire\n" );
      return -1;
   }
   ...
   if ( !vdscIsItLocked( &lock ) )
   {
      fprintf( stderr, " vdscIsItLocked invalid answer after Acquire\n" );
      return -1;
   }
   ...
   if ( vdscIsItLocked( &lock ) )
   {
      fprintf( stderr, " vdscIsItLocked invalid answer after Release\n" );
      return -1;
   }
