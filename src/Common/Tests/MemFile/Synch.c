...
void test_invalid_addr( void ** state )
{
   ...
   expect_assert_failure( psocSyncMemFile( &mem, &errorHandler ) );
...
void test_null_error( void ** state )
{
   ...
   expect_assert_failure( psocSyncMemFile( &mem, NULL ) );
...
void test_null_mem( void ** state )
{
   ...
   expect_assert_failure( psocSyncMemFile( NULL, &errorHandler ) );
