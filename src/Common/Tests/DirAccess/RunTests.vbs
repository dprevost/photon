...
Dim rc, status, numTests, numFailed, verbose
Dim objShell
...
ok_programs(2) = "GetNextNoSuchDir"
ok_programs(3) = "GetNextPass"
ok_programs(4) = "InitPass"
ok_programs(5) = "OpenNoSuchDir"
ok_programs(6) = "OpenPass"
ok_programs(7) = "Tests"

fail_programs(0)  = "CloseInvalidSig"
fail_programs(1)  = "CloseNullDir"
fail_programs(2)  = "FiniInvalidSig"
fail_programs(3)  = "FiniNullDir"
fail_programs(4)  = "GetNextInvalidSig"
fail_programs(5)  = "GetNextNoOpen"
fail_programs(6)  = "GetNextNullDir"
fail_programs(7)  = "GetNextNullError"
fail_programs(8)  = "GetNextNullpDir"
fail_programs(9)  = "InitNullDir"
fail_programs(10) = "OpenCallTwice"
fail_programs(11) = "OpenInvalidSig"
fail_programs(12) = "OpenNoInit"
fail_programs(13) = "OpenNullDir"
fail_programs(14) = "OpenNullDirname"
fail_programs(15) = "OpenNullError"
