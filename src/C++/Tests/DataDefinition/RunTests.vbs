...
ok_programs(0) = "Close"
ok_programs(1) = "ConstructCreate"
ok_programs(2) = "ConstructOpen"
ok_programs(3) = "Create"
ok_programs(4) = "GetDefinition"
ok_programs(5) = "GetLength"
ok_programs(6) = "GetNext"
ok_programs(7) = "GetType"
ok_programs(8) = "Open"
