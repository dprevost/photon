...
enum vdsErrors
{
     ...
     * where locks are implemented that way or a failure in
     * initializing a pthread_mutex (or on Windows, a critical
     * section).
     */
    ...
    /**
     * i18n string conversion error. In other words, the name of the
     * object cannot be converted to/from your current locale.
     */
