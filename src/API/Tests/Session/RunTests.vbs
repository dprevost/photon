...
ok_programs(8)  = "DestroyNotCreated"
ok_programs(9)  = "DestroyNullHandle"
ok_programs(10) = "DestroyNullName"
ok_programs(11) = "DestroyPass"
ok_programs(12) = "ExitNullHandle"
ok_programs(13) = "ExitPass"
ok_programs(14) = "InitNullHandle"
ok_programs(15) = "InitPass"
ok_programs(16) = "OpenObjNotCreated"
ok_programs(17) = "OpenObjPass"
ok_programs(18) = "RollbackNullHandle"
ok_programs(19) = "RollbackPass"

fail_programs(0) = "CloseNullSession"
fail_programs(1) = "CloseObjNullObject"
fail_programs(2) = "CloseObjNullSession"
fail_programs(3) = "OpenObjNullName"
fail_programs(4) = "OpenObjNullObject"
fail_programs(5) = "OpenObjNullSession"
