...
ok_programs(3) = "OpenNullName"
ok_programs(4) = "OpenNullObjHandle"
ok_programs(5) = "OpenNullSessHandle"
ok_programs(6) = "OpenPass"
ok_programs(7) = "OpenWrongSessHandle"

numTests = 8                 ' Sum of length of both arrays 
numFailed = 0
