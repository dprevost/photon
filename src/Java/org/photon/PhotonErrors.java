...
public enum PhotonErrors {
    ...
    // You cannot add or remove an object in a system folder.
    SYSTEM_FOLDER(73) {
        String getMessage() { return "You cannot add or remove an object in a system folder."; } },
