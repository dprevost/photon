...
public enum PhotonErrors {
    ...
    INVALID_QUASAR_ADDRESS(23) {
        String getMessage() { return "The server address is invalid (empty string, NULL pointer, etc.)."; } },
    ...
    CONNECT_ERROR(26) {
        String getMessage() { return "Socket error when trying to connect to the server."; } },

    // Socket error when trying to send a request to the server.
    SEND_ERROR(27) {
        String getMessage() { return "Socket error when trying to send a request to the server."; } },

    // Socket error when trying to receive a reply from the server.
    RECEIVE_ERROR(28) {
        String getMessage() { return "Socket error when trying to receive a reply from the server."; } },
    ...
    DATA_DEF_UNSUPPORTED(68) {
        String getMessage() { return "The data container does not support data definitions for individual data records."; } },
    ...
    SYSTEM_OBJECT(73) {
        String getMessage() { return "You cannot add or remove data if the object is a system object."; } },
    ...
    ALREADY_OPEN(74) {
        String getMessage() { return "The object is open. You must close it before reopening it."; } },
    ...
    INVALID_DEF_OPERATION(110) {
        String getMessage() { return "An invalid operation was attempted on a definition."; } },
    ...
    INVALID_DATA_DEFINITION_TYPE(121) {
        String getMessage() { return "An invalid data-definition type was provided."; } },
    ...
    private static final HashMap<Integer,PhotonErrors> reverseLookup = new HashMap<Integer,PhotonErrors>();

    static {
        for ( PhotonErrors err : PhotonErrors.values() ) {
            reverseLookup.put( err.getErrorNumber(), err );
        }
    }

    public static PhotonErrors getEnum(int errcode) {
